...
## Corpus Check
- 329 files · ~824,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2703 nodes · 5432 edges · 330 communities (248 shown, 82 thin omitted)
- Extraction: 92% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 407 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27f30b54`
...
## Communities (330 total, 82 thin omitted)
...
Cohesion: 0.06
Nodes (8): DateTimeInterface, BaseModel, CertificacionDespacho, ConteoDetalle, DevolucionDetalle, InvGeneralDiferencia, ProductoFoto, SesionAsignacion
...
Cohesion: 0.07
Nodes (9): AjusteInventario, App\Models\AjusteInventario, App\Models\SesionAsignacion, App\Models\SesionInventario, SesionAsignacion, SesionInventario, InventarioV2Controller, SesionIcgLinea (+1 more)
...
Cohesion: 0.11
Nodes (4): BaseModel, DashboardController, Recepcion, RecepcionDetalle
...
Cohesion: 0.08
Nodes (6): Illuminate\Database\Eloquent\Model, InvGeneralConteo, RecepcionCalidad, RecepcionDetalleCalidad, TraspasoDocumento, TraspasoDocumentoDetalle
...
Cohesion: 0.05
Nodes (6): Psr\Http\Message\ResponseInterface, CrossDockController, ImportExportController, InventarioController, UbicacionesController, ApiKeyMiddleware

### Community 312 - "Despacho"
Cohesion: 0.32
...
Cohesion: 0.07
Nodes (12): App\Models\Concerns\TenantScoped, AlertaStock, Ambiente, AuditLog, CategoriaProducto, CausalDevolucion, Cliente, Marca (+4 more)
...
- **Why does `BaseModel` connect `Core Models & Tenant Scope` to `Órdenes de Compra Manual`, `AlertasController`, `Packing & Expiry Control`, `BloqueoController`, `Receiving Controller`, `PickingDetalle`, `Auth & Seeding`, `Tenant Context & Middleware`, `Core Controllers Overview`, `Location Adjustment Controller`, `Inventory V2 Session Controller`, `Miscellaneous Items Controller`, `Anomaly Detection Controller`, `Replenishment & Notifications`, `OutboundController`, `Traspaso`, `InvGeneralAsignacion`, `InvGeneralEvento`, `Appointment Controller`, `Transfer Controller`, `Ubicacion`, `Aprobación de Vencimientos`, `NotificacionesController`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `TenantContext` connect `TenantContext` to `Despacho`, `TenantScoped.php`, `.__invoke`?**
