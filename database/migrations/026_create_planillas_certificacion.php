...
return [
    'up' => function () {
        ...
        // Add observaciones to conteo_inventarios
    ...
    'down' => function () {
        ...
        $schema->dropIfExists('cert_planilla_det');
        $schema->dropIfExists('cert_planillas');
        $schema->dropIfExists('lineas_planilla');
        $schema->dropIfExists('archivos_planilla');
